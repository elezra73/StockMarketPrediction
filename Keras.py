...
# The output above is the summary of our model. Notice how the last layer has 2 output features as we specified.
...
if resume_training:
    ...
    vgg16.load_state_dict(torch.load('../input/vgg16-transfer-learning-pytorch/VGG16_v2-Stock_Market_Prediction.pt'))
    print("Loaded!")
...
torch.save(vgg16.state_dict(), 'VGG16_v2-Stock_Market_Prediction.pt')
